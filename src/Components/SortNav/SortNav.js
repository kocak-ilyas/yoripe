	...
	return (
        ...
        <div className="container m-0 p-0">
			...
			<span
				...
				className={clicked === 'flatRate' ? 'badge bg-warning text-dark p-1' : 'badge bg-light text-dark p-1'}
			>
				Flat-rate
			</span>
			<span
				onClick={() => handleChange('scheduled')}
				className={clicked === 'scheduled' ? 'badge bg-warning text-dark p-1' : 'badge bg-light text-dark p-1'}
			>
				Scheduled
			</span>
		</div>
